...
using MediatR;
using MediatRExample.API.Infrastructure;
...
namespace MediatRExample.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // by giving Startup as type we basically tell that, mediatR can scan automatically
            // for handlers and register them in DI container
